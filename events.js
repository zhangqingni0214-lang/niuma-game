...
window.EVENTS = [
  ...
  // ========== A. 主线职场（晨会 / 评审 / 汇报）==========
  {
    ...
    choices: [
      { text: '"30% 是哪根手指掐出来的？数据源能不能贴一下。"', snark: true, tags: ['snark'],
...

  {
    ...
    choices: [
      { text: '"上周那个「想法」还在 GitHub 仓库吃灰。"', snark: true, tags: ['snark'],
  ...
  // ========== C. 摸鱼 / 咖啡 / 午休 ==========
  {
    ...
    choices: [
      ...
      { text: '"我留下来就是为了见证 XX 公司怎么倒的。"', snark: true, tags: ['snark'],
...

  {
    ...
    choices: [
      { text: '"竞品调研，分析他们的内容形态。"', snark: true, tags: ['snark', 'flatter'],
...

  {
    ...
    choices: [
      ...
      { text: '直接走人，不吃了。', snark: true, tags: ['snark', 'refuse'],
        effects: { mood: +10, stress: -3, salary: -5 },
...

  {
    ...
    choices: [
      ...
      { text: '在群里 @ 老板："建议下次 ¥100 现金。"', snark: true, tags: ['snark'],

...
window.EVENTS = [
  ...
  // ========== 通勤系列 ==========
  {
    ...
    choices: [
      {
        text: {
          default: '在备忘录里写《我对资本主义早高峰的十二条意见》',
          horse: '在备忘录里写《我对资本主义早高峰的十二条意见》',
          ox: '在备忘录里默默写"今天又迟到了"，下一行"明天 7:30 起"'
        },
        // 私下宣泄无人看，不收钱；但仍计入"嘴硬人设"
        tags: ['snark'],
  ...
  // ========== 健康 / 身体系列 ==========
  {
    ...
    choices: [
      {
        text: {
          default: '截图发部门群："建议公司改善加班制度。"',
          horse: '截图发部门群："建议公司改善加班制度。"',
          ox: '截图小心翼翼发部门群："那个……大家可以看看体检注意一下。"'
        },
        snark: true,
...

  {
    ...
    choices: [
      {
        text: {
          default: '拍张照发朋友圈，配文："想做一只鸽子，至少它不用写周报。"',
          horse: '拍张照发朋友圈，配文："想做一只鸽子，至少它不用写周报。"',
          ox: '拍张照发朋友圈，配文："今天的鸽子真自由～" 仅自己可见。'
        },
        snark: true,
  ...
  // ========== 副业事件池（需 side_hustle 解锁）==========
  {
    ...
    choices: [
      ...
      {
        text: {
          default: '装作打电话，故意大声："这个 case 我两天才能交，PM 别催。"',
          horse: '装作打电话，故意大声："这个 case 我两天才能交，PM 别催。"',
          ox: '装作打电话，小声："那个……我尽量明早交。" 看着后视镜手心冒汗。'
        },
        snark: true,
    ...
    choices: [
      {
        text: {
          default: '辞掉主业，全职做副业',
          horse: '辞掉主业，全职做副业',
          ox: '辞掉主业，全职做副业——但发完辞职信后看了 3 遍才点提交'
        },
        snark: true,
...

  {
    ...
    choices: [
      ...
      {
        text: {
          default: '"我看不出哪个方向有数据支撑，能不能再聊一下？"',
          horse: '"我看不出哪个方向有数据支撑，能不能再聊一下？"',
          ox: '"那个……能给我些数据吗？我想看完再说。"'
        },
        snark: true,
        effects: { skill: +5, salary: -3, stress: +5 },
...

  {
    ...
    choices: [
      {
        text: {
          default: '"这些都是新需求，下周走变更流程。"',
          horse: '"这些都是新需求，下周走变更流程。"',
          ox: '"那个……这些算新需求吗？要不咱们走个变更流程？"'
        },
        snark: true,
        effects: { mood: +14, stress: -3, salary: -8 },
  ...
  // ========== D. 加班 / 熬夜 ==========
  {
    ...
    choices: [
      ...
      { text: {
          default: '群里说"今晚搞不完，建议延后发布"。',
          horse: '群里说"今晚搞不完，建议延后发布"。',
          ox: '群里小心翼翼说："那个……今晚可能完不成，要不要考虑下延后？"'
        },
...

  {
    ...
    choices: [
      { text: {
          default: '"行，我记你一次。"',
          horse: '"行，我记你一次。"',
          ox: '"那个……好的，下次我帮你。" 心里已经在算工时账。'
        },
        tags: ['social', 'politics'],
        effects: { mood: +3, stress: +5, salary: -2 },
        result: '三天后他让你接手他半个项目。你赌的是友情，他赌的是工时。' },
      { text: {
          default: '"上次那个本来也不是大事，谢了。"',
          horse: '"上次那个本来也不是大事，谢了。"',
          ox: '"上次……其实也不算什么大事，谢谢你。" 笑得很客气。'
        },
        tags: ['refuse'],
        effects: { mood: +3, stress: +3 },
  ...
  // ========== G. 客户 / 甲方（全 client: true）==========
  {
    ...
    choices: [
      ...
      { text: {
          default: '"明早正常时间会议讨论。" 关机睡觉。',
          horse: '"明早正常时间会议讨论。" 关机睡觉。',
          ox: '"那个……我先睡了，明早一上班就回您。" 关静音躺平。'
        },
        snark: true, tags: ['snark', 'refuse'],
...

  {
    ...
    choices: [
      { text: {
          default: '"哪一处没感觉，方便指一下吗？"',
          horse: '"哪一处没感觉，方便指一下吗？"',
          ox: '"那个……能不能具体指一下，我好对照改？"'
        },
        snark: true, tags: ['snark'],
...

  {
    ...
    choices: [
      ...
      { text: {
          default: '"是不是因为咱们报价太高？我看到对面 8 折。"',
          horse: '"是不是因为咱们报价太高？我看到对面 8 折。"',
          ox: '"那个……我估计是报价的问题，对面打了 8 折。"'
        },
        snark: true, tags: ['snark'],
        effects: { mood: +10, salary: -8 },
...

  {
    ...
    choices: [
      { text: {
          default: '"这不是小修改，是大改。报价单要重过。"',
          horse: '"这不是小修改，是大改。报价单要重过。"',
          ox: '"那个……这个改动范围有点大，要不咱们重新评估下报价？"'
        },
        snark: true, tags: ['snark'],
        effects: { mood: +12, stress: +5, salary: -10 },
...

  {
    ...
    choices: [
      ...
      { text: {
          default: '"我不专业，建议找校招顾问。"',
          horse: '"我不专业，建议找校招顾问。"',
          ox: '"那个……我可能不太擅长改简历，您找专业的会更好。"'
        },
        snark: true, tags: ['snark', 'refuse'],
  ...
  // ========== H. 副业（pool:'side_hustle'） ==========
  {
    ...
    choices: [
      ...
      { text: {
          default: '截图发朋友圈，被同事看到。',
          horse: '截图发朋友圈，全公司可见——"看我也是个小创作者"。',
          ox: '截图发朋友圈，仅好友可见，但被一个不熟的同事点赞了。'
        },
        snark: true, tags: ['snark', 'social'],
  ...
  // ========== I. 健康 / 医疗 / 心理 ==========
  {
    ...
    choices: [
      ...
      { text: {
          default: '"明年再看吧。" 截图发朋友圈。',
          horse: '"明年再看吧。" 截图发朋友圈。',
          ox: '"那个……明年再说。" 收起手机，没敢告诉家里。'
        },
        snark: true, tags: ['snark', 'fishing'],
...

  {
    ...
    choices: [
      ...
      { text: {
          default: '"今天 WFH。" 发飞书然后躺回去。',
          horse: '"今天 WFH。" 发飞书然后躺回去。',
          ox: '"那个……今天颈椎不行，能不能 WFH？" 发完盯着钉钉等了 5 分钟。'
        },
        snark: true, tags: ['snark', 'fishing'],
...

  {
    ...
    choices: [
      { text: {
          default: '陪他聊了一晚上。',
          horse: '陪他聊了一晚上——你也讲了自己几个最难受的瞬间。',
          ox: '陪他聊了一晚上——大部分时间你在听，偶尔插一句"我懂"。'
        },
        tags: ['social', 'rest'],
        effects: { fatigue: +8, mood: +5, stress: -3, health: -3 },
        result: '凌晨 2 点你们都睡着了。但你第二天上班心里一直牵挂。' },
      { text: {
          default: '"你这是工作压力太大吧，要不换个工作？"',
          horse: '"你这是工作压力太大吧，要不换个工作？"',
          ox: '"那个……是不是工作太累了？要不要先休息一阵？"'
        },
        tags: ['social'],
        effects: { mood: -3, stress: +3 },
  ...
  // ========== J. 都市生活 ==========
  {
    ...
    choices: [
      ...
      { text: {
          default: '"现在市场行情？您挂中介看看，我陪您看。"',
          horse: '"现在市场行情？您挂中介看看，我陪您看。"',
          ox: '"那个……您看现在行情，要不再挂挂看？我没催您。"'
        },
        snark: true, tags: ['snark'],
...

  {
    ...
    choices: [
      { text: {
          default: '订酒店给他们，自己沙发凑合。',
          horse: '订酒店给他们，自己沙发凑合——"我家就这条件，住不下他们也住不下我。"',
          ox: '订酒店给他们，自己沙发凑合——咬咬牙 ¥1500，但妈说"住酒店多见外"。'
        },
        tags: ['shop'],
        effects: { money: -1500, mood: -3, fatigue: +5 },
        result: '一周下来 ¥1500 没了。爸说"住酒店多见外"。' },
      { text: {
          default: '"我这边太挤了，下次回家见吧。"',
          horse: '"我这边太挤了，下次回家见吧。"',
          ox: '"那个……我这边真的住不下，下次我回家好不好？"（小心翼翼）'
        },
        tags: ['refuse'],
        effects: { mood: -8, stress: +5 },
...

  {
    ...
    choices: [
      ...
      { text: {
          default: '"少给的那部分什么时候补？" 发飞书 HR。',
          horse: '"少给的那部分什么时候补？" 发飞书 HR。',
          ox: '"那个……少给的部分是漏发了吗？" 发完手抖。'
        },
        snark: true, tags: ['snark'],
        effects: { mood: +15, stress: +5, salary: -5 },
...

  {
    ...
    choices: [
      ...
      { text: {
          default: '"焦虑也没用，先睡。"',
          horse: '"焦虑也没用，先睡。"',
          ox: '"想这些有什么用……先睡吧。" 转身又看了一眼存款数字。'
        },
        snark: true, tags: ['snark', 'rest'],
        effects: { mood: +5, fatigue: -3 },
...

  {
    ...
    choices: [
      ...
      { text: {
          default: '"不签。劳动合同法第 X 条。"',
          horse: '"不签。劳动合同法第 X 条。"',
          ox: '"那个……我有点不太敢签，能不能再了解一下？"'
        },
        snark: true, tags: ['snark', 'refuse'],
        effects: { mood: +15, stress: +5, salary: -10 },
        result: 'HR 后退了一步："那再考虑下。" 但你已经被列入"不配合"名单。' },
      { text: {
          default: '"我自由职业，那加班费按市价 ¥300/小时？"',
          horse: '"我自由职业，那加班费按市价 ¥300/小时？"',
          ox: '"那个……自由职业的话加班费要不要单独算？"'
        },
        snark: true, tags: ['snark'],
        effects: { mood: +12, stress: +3, salary: -5 },
  ...
  // ========== M. 小组长专属（todo 7）==========
  {
    ...
    choices: [
      { text: {
          default: '当场反驳："我没说过，飞书记录翻一下。"',
          horse: '当场反驳："我没说过，飞书记录翻一下。"',
          ox: '小心地说："那个……能翻一下飞书记录吗？我可能没说过。"'
        },
        snark: true, tags: ['snark'],
        effects: { mood: +10, stress: +8, salary: +3 },
...

  {
    ...
    choices: [
      ...
      { text: {
          default: '"病假需要医院证明。" 发群里。',
          horse: '"病假需要医院证明。" 发群里。',
          ox: '"那个……以后病假最好附上证明，方便走流程。"（小心翼翼发群里）'
        },
        snark: true, tags: ['snark'],
        effects: { mood: +5, stress: +5, salary: -3 },
...

  {
    ...
    choices: [
      { text: {
          default: '"管得死？哦那我以后不管了。"',
          horse: '"管得死？哦那我以后不管了。"',
          ox: '"那个……我可能管得严了点，下次我注意。"（手心冒汗）'
        },
        snark: true, tags: ['snark'],
        effects: { mood: +12, stress: +5, salary: -8 },
...

  {
    ...
    choices: [
      ...
      { text: {
          default: '"我组就 3 人，要末位我去找老板谈。"',
          horse: '"我组就 3 人，要末位我去找老板谈。"',
          ox: '"那个……我们组就 3 个人，能不能跟老板沟通下指标？"'
        },
        snark: true, tags: ['snark', 'refuse'],
        effects: { mood: +15, stress: +8, salary: -10 },
...

  {
    ...
    choices: [
      ...
      { text: {
          default: '"匿名留言不予回应。" 关闭板块。',
          horse: '"匿名留言不予回应。" 关闭板块。',
          ox: '"那个……匿名留言我们先不回应？" 关板块前犹豫了 3 分钟。'
        },
        snark: true, tags: ['snark', 'refuse'],
...

  {
    ...
    choices: [
      ...
      { text: {
          default: '"测试覆盖率不够。锅不全在我。"',
          horse: '"测试覆盖率不够。锅不全在我。"',
          ox: '"那个……测试用例可能也有点漏，咱们一起看看？"'
        },
        snark: true, tags: ['snark', 'politics'],

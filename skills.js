...
window.SKILLS = [
  // ===== Tier 1 · 嘴硬入门（10 业力）=====
  {
    ...
    requires: [],
    type: 'passive',
    description: '咒法上身，咖啡因不再伤身。喝咖啡不扣健康，提神效果 +50%。',
  },
  {
    id: 'thick_skin',
    tier: 1,
    ...
    requires: [],
    type: 'active+passive',
    description: '脸皮如钟罩。怼老板时工资损失减半，解锁部分事件的"嘴更硬"选项。',
  },
  {
    id: 'rubber_duck',
    tier: 1,
    ...
    requires: [],
    type: 'active+passive',
    description: '对鸭念咒，bug 自现。加班自动多回 5 点技能，解锁技术类隐藏解法。',
  },
  {
    id: 'social_butterfly',
    tier: 1,
    ...
    requires: [],
    type: 'active+passive',
    description: '群里阴影里的影子操盘手。同事/团建类心情 +5，解锁"拉同事下水"选项。',
  },
  ...
  },
  {
    ...
    type: 'active',
    description: '变法者，先变心。解锁"站队 / 甩锅 / 借势"类隐藏选项，能换工资或挡刀。',
  },
  {
    id: 'promotion_radar',
    tier: 2,
    ...
    type: 'active+passive',
    description: '老板给你画饼，你给老板画饼。老板对话工资 +2，解锁"反向画饼"选项。',
  },
  ...
  },
  {
    ...
    type: 'passive',
    description: '久病成医，逆境出英雄。健康低于 30 时，所有压力增量减半。',
  },
  ...
  // ===== Tier 4 · 化境（50 业力）=====
  {
    ...
    type: 'meta',
    description: '一个跟头十万八千里，财不离身。新一世继承上一世存款的 5%。',
  },
];
